...
package net.mcreator.biomeandother.particle;
...
public class SlimefunguspoisonParticle extends BiomeAndOtherModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public SlimefunguspoisonParticle(BiomeAndOtherModElements instance) {
		super(instance, 14);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("slimefunguspoison"));
	}
