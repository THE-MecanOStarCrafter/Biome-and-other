...
public class ApplesaplingBlock extends BiomeAndOtherModElements.ModElement {
	@ObjectHolder("biome_and_other:applesapling")
	public static final Block block = null;
	public ApplesaplingBlock(BiomeAndOtherModElements instance) {
		super(instance, 17);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("applesapling"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("biome_and_other:applesapling"), configuredFeature);
		}
	}
	@SubscribeEvent
