...
public class MeetknifeItem extends BiomeAndOtherModElements.ModElement {
	@ObjectHolder("biome_and_other:meetknife")
	public static final Item block = null;
	public MeetknifeItem(BiomeAndOtherModElements instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Use it to cut meet"));
			}
		}.setRegistryName("meetknife"));
	}
